...
class BirthdayDeleteView(DeleteView):
    model = Birthday
    #template_name = 'birthday/birthday.html' так как создали страницу удаления
    success_url = reverse_lazy('birthday:list') 
